...
2.  Écrire les expressions suivantes avec le moins de parenthèses
    possibles :
...
3.  Exécuter de nouveau le code, on doit obtenir un message d’erreur
    indiquant que
...
1.  Tester ce programme pour les entrées 605 et 506. La spécification du
