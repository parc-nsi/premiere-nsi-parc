...
\item
  ...
  conséquent si on veut renvoyer les données du formulaire un message en
  popup avertit que ce nouvel envoi aura pour effet de bord modifier
  l'état du serveur et par exemple d'enregistrer un nouvel achat s'il
  s'agit d'un formulaire de commande.
\end{itemize}
