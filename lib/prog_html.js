...
/* Préambule :
 ...
 $(function() {
		...
		/* ********************************************************
	               Pour les popup de la partie JSX
	       ******************************************************** */
            tabcorrigejs = document.getElementsByClassName("cor_exohtmljs");
            tabpopupjs = document.getElementsByClassName("popupcor_htmljs");
            
            
	    
            for(i=0; i<tabcorrigejs.length; i++)
		    {
  
			        correctionExo_JS[i] = CodeMirror.fromTextArea(tabcorrigejs[i], {
				        lineNumbers: true,
				        mode: mixedMode,
				        matchBrackets: true,
						readOnly: true,
			        ...
			        popup[i] = (function(tmp) { return function(){
				        ...
				        var texte = correctionExo_JS[tmp].getValue();
