...
#%% Chargement de deux tables (prénoms à Rennes en 2011 et 2010)
...
#compléter pour filtrer uniquement les prénoms féminins dans prenom_10_11
...
# réunir les tables prenom_14 et prenom_15 dans prenom_14_15
...
#%%  Fusion des tables par jointure
...
#%%  Une solution aux incohérences précédentes : utiliser un identifiant unique, on reprend les jointures 
